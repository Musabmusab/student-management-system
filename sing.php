...
<div class="flex items-center justify-center min-h-screen">
    ...
    <div class="flex justify-between mb-6">
                ...
                <button class="px-4 py-2 font-bold text-gray-900 bg-red-500 rounded hover:bg-red-600"><a href="sing.php">Sign In</a></button>
     </div>
            <form action="singlogic.php" method="post" id="registerForm" class="space-y-4">
    <div>
                    <label for="name" class="block mb-2">Name</label>
                    <input type="text" id="name" name="name" class="w-full px-4 py-2 text-gray-900 bg-gray-300 rounded" >
     </div>
    <div>
                    <label for="email" class="block mb-2">Email</label>
                    <input type="email" id="email" name="email" class="w-full px-4 py-2 w-full px-4 py-2 text-gray-900  bg-gray-300 rounded" >
     </div>
     <div>
                    <label for="name" class="block mb-2">Phone Number</label>
                    <input type="text" id="name" name="phone" class="w-full px-4 py-2 text-gray-900 bg-gray-300 rounded" >
     </div>

                        <label for="password" class="block mb-2">Password</label>
                        <div class="relative">
                        <input type="password" name="password" id="password" class="w-[350px] px-4 py-2 text-gray-900 bg-gray-300 rounded"">
        ...
        <button name="submit" class="w-full mt-7 px-4 py-2  font-bold text-white-900 bg-red-900 rounded hover:bg-red-600">Sing In</button>
