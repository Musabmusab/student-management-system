        ...
        <div class="overflow-x-auto">
            <table class="min-w-full mt-5 table-auto border-collapse table">
                ...
                <tbody>
                    <?php 
                    include'config.php';
                    $record=mysqli_query($con,"SELECT * FROM `teacher`");
                    ...
                    <tr>
                        ...
                        <td class='border border-gray-600'> <a href='delete.php ? id=$row[id] '><button class='px-4 py-2 font-bold text-gray-900 bg-red-500 rounded hover:bg-red-600'>Delete</a></td>
                    </tr>";
                    };
                    ?>
                </tbody>
