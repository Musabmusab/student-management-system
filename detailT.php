...
<body class="p-4">
<h1 class="text-3xl font-bold mb-4 text-red-500">View Teachers Table</h1> 
<div class="flex">
                ...
                <thead>
                    <tr>
                        ...
                        <th class="border border-gray-600">District</th>
                         ...
                         <th class="border border-gray-600">state</th>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class='border border-gray-600'>$row[nationality]</td>
                         <td class='border border-gray-600'>$row[state]</td>
